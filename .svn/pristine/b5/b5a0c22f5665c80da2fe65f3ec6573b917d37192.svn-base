...
<body>
	<div class="header">
		<font size="5px">添加试题</font>

	</div>
	<div class="body1">
	<jsp:useBean id="itemBean" class="com.wuxianedu.domain.ItemBean" scope="request"></jsp:useBean>
	<form:form modelAttribute="itemBean" action="insertItem" method="POST">
		<div class="bodytext0">
