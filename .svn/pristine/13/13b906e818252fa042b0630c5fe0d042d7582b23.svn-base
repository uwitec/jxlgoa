 ...
 */
 ...
 $.extend(Calendar.prototype,{
	...
	_renderCalendarPanel: function(){
		...
		var	date_button = $('<div class="date_button"><a href="javascript:void(0)" class="date-current">today</a><a href="javascript:void(0)" class="date-closed">close</a><a href="javascript:void(0)" class="date-ok">confirm</a></div>').appendTo(date_pane);
 ...
 var defaults = {
	...
	language         :       {
								...
								weekList:["sun","mon","tus","won","fou","fa","sta"]}        
 };