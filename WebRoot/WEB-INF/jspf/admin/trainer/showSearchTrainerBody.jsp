...
<form action="${pageContext.request.contextPath}/admin/searchTrainerByPage" method="post" >
		...
		<div style="width:800px;margin-top: 20px;margin-left: 30px" >
			...
			<div class="form-group col-lg-2" style="float:left">
				<select class="form-control col-lg-2" name="selectType" id="selectType"> 
			...
			<div class="form-group col-lg-2" style="float:left">
				<select  class="form-control col-lg-2" name="selectStatus" id="selectStatus">
						<option value="">请选择</option>
 ...
 <div style="width:800px;margin-left: 30px;margin-top: 20px">
   	<table style="height: 50px" class="table table-bordered  col-lg-2" >
   		<tr>
  ...
  <script type="text/javascript">
	 	...
	 	function gotoPage(currentPage){
			...
			var selectStatus = $("#selectStatus").val();
  			window.location.href="${pageContext.request.contextPath }/admin/searchTrainerByPage?currentPage="+currentPage+"&trainerName="+trainerName+"&selectType="+selectType+"&entryTime="+entryTime+"&selectStatus="+selectStatus;
