 ...
 <form action="${pageContext.request.contextPath}/adviser/searchAdviserByPage" method="post">
			<div style="width:800px;margin-top: 20px;margin-left: 30px" >
			 <div class="input-group col-lg-2 " style="float:left" >
	            ...
	            <input type="text" class="form-control" name="adviserName" id="adviserName">
			 </div>
 ...
 <script type="text/javascript">
	 	...
	 	function gotoPage(currentPage){
			...
			var selectType = $("#selectType").val();
  			window.location.href="${pageContext.request.contextPath }/adviser/searchAdviserByPage?currentPage="+currentPage+"&adviserName="+adviserName+"&entryTime="+entryTime+"&selectType="+selectType;
  		};
  </script>
 <script type="text/javascript">
